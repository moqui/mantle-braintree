...
try {
    ...
    if (!result.isSuccess()) {
        for (ValidationError error : result.getErrors().getAllDeepValidationErrors()) {
            ...
            ec.service.sync().name("mantle.account.BraintreeServices.save#BraintreeResponse").parameters([
                    paymentGatewayConfigId:"RchBraintree", paymentOperationEnumId:"PgoRefund", amount:amount,
    ...
    ec.service.sync().name("mantle.account.BraintreeServices.save#BraintreeResponse").parameters([
            paymentGatewayConfigId:"RchBraintree", paymentOperationEnumId:"PgoRefund",
